      ...
      <DialogContent className='sm:max-w-md lg:max-w-lg'>
        <DialogHeader>
          <div className='flex items-center gap-3 mb-2'>
            ...
            <DialogTitle className='text-lg sm:text-xl'>Conflit de promotions</DialogTitle>
          </div>
        ...
        <div className='my-4'>
          ...
          <div className='space-y-2 max-h-60 overflow-y-auto'>
            {overlappingPromotions.map(promo => (
              <div key={promo.id} className='p-3 bg-red-50 border border-red-200 rounded-lg'>
                <div className='flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2'>
                  <div className='flex items-center gap-2'>
                    ...
                    {promo.product && (
                      <span className='text-xs text-red-600 truncate'>({promo.product.name})</span>
                    )}
                  </div>
