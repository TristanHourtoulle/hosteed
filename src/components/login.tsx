      ...
      <div className='w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50'>
        <div className='w-full max-w-md space-y-8'>
          ...
          <div className='text-center'>
            ...
            <p className='text-gray-600'>Remplissez les champs ci dessous pour vous connecter</p>
          </div>
          ...
          <form className='space-y-6' onSubmit={handleSubmit}>
            ...
            <div className='text-right'>
              <Link href='/forgetPassword' className='text-sm text-blue-600 hover:text-blue-500'>
                Mot de passe oublié ?
              </Link>
            </div>
          ...
          <div className='text-center'>
            <p className='text-gray-600'>
              ...
              <button onClick={submit} className='text-blue-600 hover:text-blue-500 font-medium'>
                S&apos;inscrire
              </button>
            </p>
          </div>
