      ...
      <CardContent className="space-y-4">
          ...
          <div className="flex items-center gap-1">
            ...
            {showDetails && (
              <span className="text-xs text-gray-400">
                ({formatted.hostCommissionPercentage} + {calculation.breakdown.hostCommissionFixed.toFixed(2)}€)
              </span>
            )}
          </div>
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-1">
            ...
            {showDetails && (
              <span className="text-xs text-gray-400">
                ({formatted.clientCommissionPercentage} + {calculation.breakdown.clientCommissionFixed.toFixed(2)}€)
              </span>
            )}
          </div>
