              ...
              <div className='space-y-6'>
                <Card className='border-blue-200 bg-blue-50'>
                  ...
                  <CardContent className='space-y-4 text-blue-700'>
                    <div className='space-y-3'>
                      <p>
                        • <strong>Utilisez des titres</strong> pour structurer votre article
                      </p>
                      <p>
                        • <strong>Aérez votre texte</strong> avec des paragraphes courts
                      </p>
                      <p>
                        • <strong>Ajoutez des images</strong> pour illustrer vos propos
                      </p>
                      <p>
                        • <strong>Utilisez des listes</strong> pour organiser les informations
                      </p>
                      <p>
                        • <strong>Prévisualisez</strong> toujours avant de publier
                      </p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className='border-green-200 bg-green-50'>
                  ...
                  <CardContent className='space-y-4 text-green-700'>
                    <div className='space-y-3'>
                      <p>
                        • Vous pouvez utiliser du <strong>HTML</strong> directement dans votre
                        Markdown
                      </p>
                      <p>
                        • Laissez une <strong>ligne vide</strong> entre les paragraphes
                      </p>
                      <p>
                        • Utilisez <code className='bg-white px-1 rounded'>---</code> pour créer une
                        ligne de séparation
                      </p>
                      <p>
                        • Les <strong>emojis</strong> sont supportés : 🎉 ✨ 📝
                      </p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className='border-amber-200 bg-amber-50'>
                  ...
                  <CardContent className='space-y-4 text-amber-700'>
                    <div className='space-y-3'>
                      <p>
                        • N&apos;oubliez pas l&apos;<strong>espace après #</strong> pour les titres
                      </p>
                      <p>
                        • Les <strong>liens</strong> doivent être au format [texte](url)
                      </p>
                      <p>
                        • Attention aux <strong>caractères spéciaux</strong> dans les URLs
                      </p>
                      <p>
                        • Vérifiez l&apos;<strong>indentation</strong> pour les listes imbriquées
                      </p>
                    </div>
                  </CardContent>
                </Card>
