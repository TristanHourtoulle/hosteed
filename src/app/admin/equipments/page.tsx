...
export default function EquipmentsPage() {
  ...
  const handleUpdateOption = async () => {
    ...
    try {
      ...
      const updatedOption = await updateEquipment(editingOption.id, editOptionName, editingOption.icon || 'default-icon')
      
      if (updatedOption) {
        setEquipments(equipments.map(opt => 
              ...
              <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
                <DialogContent className='sm:max-w-[425px]'>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Modifiez le nom de cet équipement.
                    </DialogDescription>
                  </DialogHeader>
                  <div className='space-y-4 py-4'>
                    <div className='space-y-2'>
              ...
              <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
                <DialogContent className='sm:max-w-[425px]'>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Êtes-vous sûr de vouloir supprimer l&apos;équipement &quot;{deletingOption?.name}&quot; ?
