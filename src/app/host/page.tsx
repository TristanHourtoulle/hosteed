        ...
        {session?.user && (
          <div className='mb-8 flex justify-between items-center'>
            ...
            <div className='flex gap-4'>
              <Button onClick={() => router.push('/search')}>Recherche avancée</Button>
            </div>
          </div>
        )}
              ...
              <CardContent className='space-y-6'>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={e =>
                      setFilters(prev => ({ ...prev, searchRadius: parseInt(e.target.value) }))
                    }
                    className='w-full'
                  />
                </div>
                ...
                <div className='grid grid-cols-1 gap-4'>
                  <div>
                    ...
                    <input
                      ...
                      onChange={e =>
                        setFilters(prev => ({ ...prev, arrivingDate: e.target.value }))
                      }
