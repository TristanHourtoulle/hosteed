...
interface GuestPricingDetailsCardProps {
  rent: {
...
export default function GuestPricingDetailsCard({ rent }: GuestPricingDetailsCardProps) {
    ...
    <div className='bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden'>
      ...
      <div className='bg-gradient-to-r from-blue-50 to-indigo-50 p-6 border-b border-gray-100'>
        <div className='flex items-center gap-3'>
          ...
          <div>
            <h2 className='text-xl font-bold text-gray-900'>Détails de votre paiement</h2>
      ...
      <div className='p-6 space-y-6'>
          ...
          {rent.totalSavings && rent.totalSavings > 0 && (
            <div className='bg-green-50 border border-green-200 rounded-xl p-3'>
              <div className='flex items-center justify-between'>
                <span className='text-sm font-medium text-green-700'>Vos économies</span>
          ...
          <div className='space-y-3'>
            ...
            <div className='space-y-2'>
              ...
              <div className='bg-blue-50 border border-blue-200 rounded-lg p-3'>
                <div className='flex justify-between items-center'>
                  <span className='text-sm font-medium text-blue-700'>Total services</span>
        ...
        <div className='space-y-3'>
          ...
          <div className='space-y-2'>
            ...
            <div className='bg-blue-50 border border-blue-200 rounded-lg p-3'>
              <div className='flex justify-between items-center'>
                <span className='text-sm text-blue-700'>Frais de service</span>
