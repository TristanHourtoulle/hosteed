    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-sm p-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-8">POLITIQUE DE CONFIDENTIALITÉ - HOSTEED</h1>
          
          <div className="space-y-8">
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">1. Informations Collectées</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">3. Partage des Informations</h2>
              <div className="space-y-3 text-gray-700">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">6. Droits des Utilisateurs</h2>
              <div className="space-y-3 text-gray-700">
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">7. Cookies et Technologies Similaires</h2>
              <p className="text-gray-700">
                Nous utilisons des cookies et technologies similaires pour collecter des informations et personnaliser votre expérience.
              </p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">8. Transferts Internationaux de Données</h2>
              <p className="text-gray-700">
                Vos données peuvent être transférées vers des pays tiers, avec les mesures de protection appropriées.
              </p>
            </section>

            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">9. Modifications de la Politique</h2>
              <p className="text-gray-700">
