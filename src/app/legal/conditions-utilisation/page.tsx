          ...
          <div className='space-y-8'>
            <section>
              ...
              <div className='space-y-3 text-gray-700'>
                ...
                <ul className='list-disc list-inside space-y-2 ml-4'>
                  <li>
                    <strong>&quot;Utilisateur&quot;</strong> désigne toute personne utilisant la
                    plateforme
                  </li>
                  <li>
                    <strong>&quot;Client&quot;</strong> désigne l&apos;utilisateur effectuant une
                    réservation
                  </li>
                  <li>
                    <strong>&quot;Fournisseur&quot;</strong> désigne l&apos;hébergeur ou prestataire
                    de services
                  </li>
                  <li>
                    <strong>&quot;Contenu&quot;</strong> désigne toutes les informations publiées
                    sur la plateforme
                  </li>
                </ul>
              </div>
            ...
            <section>
              ...
              <p className='text-gray-700'>
                Hosteed est une plateforme en ligne permettant la réservation d&apos;hébergements,
                de transport et de services de voyage. Nous agissons en tant qu&apos;intermédiaire
                entre les clients et les fournisseurs de services.
              </p>
            </section>
            ...
            <section>
              ...
              <div className='space-y-3 text-gray-700'>
                ...
                <ul className='list-disc list-inside space-y-2 ml-4'>
                  <li>
                    La réservation constitue un contrat direct entre l&apos;utilisateur et le
                    fournisseur
                  </li>
                  <li>Hosteed agit uniquement en tant qu&apos;intermédiaire</li>
                  <li>
                    Les conditions spécifiques du fournisseur s&apos;appliquent à chaque réservation
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section>
              ...
              <div className='space-y-3 text-gray-700'>
                ...
                <ul className='list-disc list-inside space-y-2 ml-4'>
                  <li>
                    Une licence limitée d&apos;utilisation personnelle et non commerciale est
                    accordée aux utilisateurs
                  </li>
                  <li>
            ...
            <section>
              ...
              <div className='space-y-3 text-gray-700'>
                ...
                <ul className='list-disc list-inside space-y-2 ml-4'>
                  ...
                  <li>
                    Hosteed décline toute responsabilité pour les dommages résultant de
            ...
            <section>
              ...
              <div className='space-y-3 text-gray-700'>
                ...
                <ul className='list-disc list-inside space-y-2 ml-4'>
                  ...
                  <li>
                    Les utilisateurs disposent de droits d&apos;accès et de modification de leurs
                    données
                  </li>
                </ul>
              </div>
            ...
            <section>
              ...
              <p className='text-gray-700'>
                Hosteed se réserve le droit de mettre à jour ces conditions à tout moment. Les
