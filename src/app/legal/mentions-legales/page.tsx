          ...
          <div className="space-y-6">
            <section>
              ...
              <div className="space-y-2 text-gray-700">
                ...
                <p><span className="font-medium">Capital social :</span> 5000 EUR</p>
                <p><span className="font-medium">Siège social :</span> 36 Avenue de Normandie, 93160 Noisy le Grand</p>
                <p><span className="font-medium">Numéro SIRET :</span> 832 134 571 00021</p>
                <p><span className="font-medium">TVA :</span> FR85832134571</p>
                <p><span className="font-medium">Registre du commerce :</span> Bobigny</p>
                <p><span className="font-medium">Directeur de publication :</span> Santatra BENJAMINA</p>
                <p>
            ...
            <section>
              ...
              <div className="space-y-2 text-gray-700">
                ...
                <p><span className="font-medium">Adresse :</span> 2, rue Kellermann, 59100 Roubaix</p>
              </div>
            </section>
