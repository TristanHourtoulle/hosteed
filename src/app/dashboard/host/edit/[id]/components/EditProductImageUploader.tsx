...
interface EditProductImageUploaderProps {
...
export default function EditProductImageUploader({
  selectedFiles,
  setSelectedFiles,
  isUploadingImages,
    ...
    if (files && files.length > 0) {
      if (selectedFiles.length + files.length > 35) {
        setError({
          ...
          message: 'Vous ne pouvez télécharger que 35 images maximum.',
          details: [
