...
interface EditProductPricingFormProps {
  formData: FormData
  onInputChange: (
            ...
            <div className='flex items-center gap-2'>
              ...
              <div>
                ...
                <p className='text-slate-600 text-sm mt-1'>
                  Modifiez vos prix de base et tarifs spéciaux
                </p>
              </div>
            </div>
          </CardHeader>
        ...
        <Card className='border-orange-200 bg-gradient-to-br from-orange-50 to-amber-50'>
          ...
          <CardContent className='space-y-6'>
            <div className='bg-white/60 rounded-lg p-6 border border-orange-200'>
              <h3 className='font-semibold text-orange-900 mb-3'>Avant de sauvegarder</h3>
              <ul className='text-sm text-orange-800 space-y-2'>
                ...
                <li className='flex items-center gap-2'>
                  <span className='w-2 h-2 bg-orange-500 rounded-full'></span>
                  Assurez-vous d&apos;avoir mis à jour les photos si nécessaire
                </li>
                <li className='flex items-center gap-2'>
                  <span className='w-2 h-2 bg-orange-500 rounded-full'></span>
                  Les modifications seront prises en compte immédiatement
                </li>
              </ul>
            </div>
