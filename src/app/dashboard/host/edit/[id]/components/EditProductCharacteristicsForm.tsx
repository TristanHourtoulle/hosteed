...
interface EditProductCharacteristicsFormProps {
  formData: FormData
...
export default function EditProductCharacteristicsForm({
  formData,
  typeRent,
  onInputChange,
  onCheckboxChange,
  itemVariants
}: EditProductCharacteristicsFormProps) {
          ...
          <div className='flex items-center gap-2'>
            ...
            <div>
              ...
              <p className='text-slate-600 text-sm mt-1'>
                Modifiez les détails techniques de votre hébergement
              </p>
            </div>
          </div>
        </CardHeader>
