...
export async function updateSpecialPrices(id: string, pricesMga: string, pricesEuro: string, day: DayEnum[], startDate: Date | null, endDate: Date | null, activate: boolean) {
    try {
