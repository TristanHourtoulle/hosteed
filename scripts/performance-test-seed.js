...
const coordinates = [
  ...
  { lat: -18.1667, lng: 49.4 }, // Toamasina
  { lat: -21.45, lng: 47.0833 }, // Fianarantsoa
  { lat: -15.7167, lng: 46.3167 }, // Mahajanga
  { lat: -14.2667, lng: 50.1667 }, // Sambava
  { lat: -23.35, lng: 43.6667 }, // Toliara
  { lat: -20.5333, lng: 47.25 }, // Ambositra
]
...
async function main() {
  ...
  try {
    ...
    console.log(
      `🔍 ${products.filter(p => p.validate === 'NotVerified').length} produits en attente de validation`
    )
