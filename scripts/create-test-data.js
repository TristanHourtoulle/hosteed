  ...
  try {
    ...
    const product1 = await prisma.product.create({
      data: {
        ...
        description: 'Magnifique villa avec vue imprenable sur l\'océan Indien, située dans un cadre exceptionnel à Nosy Be.',
    ...
    const product2 = await prisma.product.create({
      data: {
        ...
        description: 'Séjour authentique au coeur de la forêt primaire d\'Andasibe, proche du parc national.',
